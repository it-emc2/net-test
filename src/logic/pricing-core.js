...
// src/logic/pricing-core.js
//
// The pricing rules, with every server-only dependency injected so this file
// can run unchanged in the browser too (see public/pricing-client.js — offline
// the technician still needs a total). Nothing here may import mongoose, the
// config service or the vigor client directly; src/logic/pricing.js is the
// server wiring that supplies them.
