...
function getAngebotTemplatePath(body) {
  ...
  switch (offer) {
    ...
    case "ah":
    case "ah-alt":
      // AH now uses the DIN 5008 / A4 window-envelope template
      // (generated by generate-ah-alt.mjs). The old US-Letter
      // Angebot-AH.docx remains in the repo but is no longer served.
      file = "Angebot-AH-alt-4.docx";
      break;
    case "bu":
